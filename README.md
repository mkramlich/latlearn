...
To help understand what latlearn can do, there is a (very simple) sample of a latency report file included in this repo. It is at [./report-examples/latency-report.txt](./report-examples/latency-report.txt) But it is also recommended that you run [./buildrun.sh](./buildrun.sh) and poke around.
